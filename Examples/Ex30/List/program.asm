...
; 0000 000E {UBRRH = (unsigned char)(ubrr>>8);
...
;	ubrr -> Y+0
	...
	ANDI R31,HIGH(0x0)
	OUT  0x20,R30
; 0000 000F  UBRRL = (unsigned char)ubrr;
	LD   R30,Y
	OUT  0x9,R30
; 0000 0010 UCSRB = (1<<RXEN)|(1<<TXEN)|(1<<RXCIE);
	LDI  R30,LOW(152)
	OUT  0xA,R30
; 0000 0011 UCSRC = (1<<URSEL)|(3<<UCSZ0);}
	LDI  R30,LOW(134)
	OUT  0x20,R30
	JMP  _0x20A0002
