...
_0x0:
	.DB  0x41,0x6D,0x70,0x65,0x72,0x65,0x3D,0x20
	.DB  0x20,0x20,0x20,0x20,0x20,0x20,0x41,0x0
_0x2000060:
	.DB  0x1
_0x2000000:
...
; 0000 001A     lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	CALL _lcd_gotoxy
; 0000 001B     lcd_puts("Ampere=       A");
	__POINTW2MN _0xB,0
	CALL _lcd_puts
; 0000 001C     lcd_gotoxy(8,0);
	LDI  R30,LOW(8)
	ST   -Y,R30
	LDI  R26,LOW(0)
	CALL _lcd_gotoxy
