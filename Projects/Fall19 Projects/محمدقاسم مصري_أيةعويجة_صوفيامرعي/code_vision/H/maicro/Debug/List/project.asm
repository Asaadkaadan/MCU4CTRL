...
_0x0:
	.DB  0x66,0x61,0x73,0x74,0x3D,0x0,0x76,0x6F
	.DB  0x6C,0x74,0x61,0x67,0x65,0x3D,0x0
_0x2000003:
	.DB  0x80,0xC0
_0x2020060:
	.DB  0x1
...
SUBOPT_0x0:
	LDS  R26,_speed_ref
	LDS  R27,_speed_ref+1
	LDS  R24,_speed_ref+2
	LDS  R25,_speed_ref+3
	RET

;OPTIMIZER ADDED SUBROUTINE, CALLED 2 TIMES, CODE SIZE REDUCTION:9 WORDS
SUBOPT_0x1:
	LDS  R30,_speed_ref
	LDS  R31,_speed_ref+1
	LDS  R22,_speed_ref+2
	LDS  R23,_speed_ref+3
	__GETD2N 0x40A00000
	RET
...
SUBOPT_0x2:
	STS  _speed_ref,R30
	STS  _speed_ref+1,R31
	STS  _speed_ref+2,R22
	STS  _speed_ref+3,R23
	RET
