...
_0x11:
	.DB  0x9,0x8,0xC,0x4,0x6,0x2,0x3,0x11
	.DB  0x0,0x0,0x80,0xBF,0x0,0x0,0x80,0x3F
	.DB  0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0
	.DB  0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0
	.DB  0x6F,0x12,0x83,0x3A,0x0,0x0,0x0,0x0
	.DB  0x0,0x0,0x80,0x3F
_0x0:
	.DB  0x50,0x6F,0x73,0x69,0x74,0x69,0x6F,0x6E
	.DB  0x3D,0x0,0x43,0x31,0x0,0x20,0x20,0x0
	.DB  0x43,0x32,0x0,0x43,0x33,0x0,0x43,0x34
	.DB  0x0,0x43,0x35,0x0
_0x2000003:
	.DB  0x80,0xC0
_0x2020060:
	.DB  0x1
...
_0xF:
	LDI  R30,LOW(0)
	STS  _Position_ref,R30
	STS  _Position_ref+1,R30
	STS  _Position_ref+2,R30
	STS  _Position_ref+3,R30
; 0000 0045 
; 0000 0046 
; 0000 0047 
; 0000 0048 }
...
; 0000 00B5      lcd_puts("C1");
	__POINTW2MN _0x29,10
	RJMP _0x39
; 0000 00B6      }
; 0000 00B7      else
_0x2A:
; 0000 00B8      lcd_puts("  ");
	__POINTW2MN _0x29,13
_0x39:
	CALL _lcd_puts
; 0000 00B9 
; 0000 00BA 
...
; 0000 00BD      lcd_puts("C2");
	__POINTW2MN _0x29,16
	RJMP _0x3A
; 0000 00BE      }
; 0000 00BF      else
_0x2C:
; 0000 00C0      lcd_puts("  ");
	__POINTW2MN _0x29,19
_0x3A:
	CALL _lcd_puts
; 0000 00C1 
; 0000 00C2 
...
; 0000 00C7      lcd_puts("C3");
	__POINTW2MN _0x29,22
	RJMP _0x3B
; 0000 00C8      }
; 0000 00C9      else
_0x2E:
; 0000 00CA      lcd_puts("  ");
	__POINTW2MN _0x29,25
_0x3B:
	CALL _lcd_puts
; 0000 00CB 
; 0000 00CC 
...
; 0000 00D1      lcd_puts("C4");
	__POINTW2MN _0x29,28
	RJMP _0x3C
; 0000 00D2      }
; 0000 00D3      else
_0x30:
; 0000 00D4      lcd_puts("  ");
	__POINTW2MN _0x29,31
_0x3C:
	CALL _lcd_puts
; 0000 00D5 
; 0000 00D6 
...
; 0000 00DB      lcd_puts("C5");
	__POINTW2MN _0x29,34
	RJMP _0x3D
; 0000 00DC      }
; 0000 00DD      else
_0x32:
; 0000 00DE      lcd_puts("  ");
	__POINTW2MN _0x29,37
_0x3D:
	CALL _lcd_puts
...
; 0000 00EC e_k=Position_ref-Position;
	...
	LDS  R24,_Position+2
	LDS  R25,_Position+3
	LDS  R30,_Position_ref
	LDS  R31,_Position_ref+1
	LDS  R22,_Position_ref+2
	LDS  R23,_Position_ref+3
	CALL __SUBF12
	__PUTD1S 28
...
SUBOPT_0x0:
	STS  _Position_ref,R30
	STS  _Position_ref+1,R31
	STS  _Position_ref+2,R22
	STS  _Position_ref+3,R23
	RET
